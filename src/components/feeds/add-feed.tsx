...
const AddFeed = ({ feedChange }: { feedChange: () => void }) => {
  ...
  const isVideoLink = (link: string | null | undefined) => {
    ...
    const youtubeRegex =
      /^(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:embed\/|watch\?v=|v\/|.+\/|user\/\S+|[^\/]+)([a-zA-Z0-9_-]{11})|youtu\.be\/([a-zA-Z0-9_-]{11}))(?:\S+)?$/;
            ...
            >
              ...
              >
                <ModalCloseButton
                  ...
                  left='0'
                  onClick={() => {
                    reset(), handleIsAttachFile(), handleIsAttachUrl();
                  }}
                />
                ...
                >
                  <HStack>
                    <Icon
                      as={SlPicture}
                      boxSize={8}
                      onClick={handleIsAttachFile}
                      cursor='pointer'
                    />
                    <Icon
                      as={AiOutlineLink}
                      boxSize={8}
                      onClick={handleIsAttachUrl}
                      cursor='pointer'
                    />
                  </HStack>
                  <Button variant='solidBlue' type='submit'>
                    Post
                  </Button>
                </Flex>
              </ModalFooter>
